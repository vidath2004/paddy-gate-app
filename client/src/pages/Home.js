...
// Import images
import riceFieldBg from '../assets/images/background/rice-field-bg.jpg';
import farmerIllustration from '../assets/images/background/farmer-illustration.png';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="container mx-auto text-white text-center">
            <h2 className="text-3xl font-bold">Empowering Agricultural Commerce</h2>
          </div>
        </section>

        {/* Existing sections from previous Home page */}
